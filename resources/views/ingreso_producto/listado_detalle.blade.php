            ...
            <div class="card" style="background: #FFFFFF">
                <div class="header" >
                    ...
                    <div style="float: right">
                        <a href="{{route('ingresoproductos.index')}}" type="button" data-toggle="tooltip" title="Ingresar Compra" data-placement="bottom"
                        ...
                        <table class="table table-bordered table-hover js-basic-example dataTable table-custom">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td style="text-align: center"><a href="/ingreso-productos-list-pdf/{{$xd->id_producto}}" class="btn btn-sm btn-warning" target="_BLANK"><i class="fa fa-print"></i></a></td>
                                    <td style="text-align: center">
                                        @if($xd->estado==1)
                                        <form action="/ingreso-productos-a-kardex/{{$xd->id_producto}}" method="POST" style="display: inline-block">
                                            @csrf
