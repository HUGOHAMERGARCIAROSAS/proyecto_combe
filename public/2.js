        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _this.gastos.splice(0);

                if (!(_this.tipoComprobante != 0)) {
                  _context.next = 4;
                  break;
                }

                _context.next = 4;
                return axios__WEBPACK_IMPORTED_MODULE_1___default.a.get('/otrosGastos/gastosTipo/' + _this.tipoComprobante).then(function (res) {
